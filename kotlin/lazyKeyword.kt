...
It is initialised only once. Next time when you use it, you get the value from cache memory.

It is thread safe
It is initialised in the thread where it is used for the first time.
